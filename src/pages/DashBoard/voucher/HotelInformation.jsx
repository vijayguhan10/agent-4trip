function HotelInformation({ hotel, onChange, onFileUpload }) {
  const handleFileChange = (e) => {
    const file = e.target.files[0];
    if (file) {
      onFileUpload("hotel", file);
    }
  };
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange("hotel", "bookingNumber", e.target.value)
              }
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) =>
                onChange("hotel", "checkOutdate", e.target.value)
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
            />
          </div>

          <label className="text-primary flex items-center cursor-pointer">
            <input
              type="file"
            ...
            {hotel.hotelFile ? hotel.hotelFile.name : "Upload PDF"}
          </label>
        </div>
      </div>
    </div>
